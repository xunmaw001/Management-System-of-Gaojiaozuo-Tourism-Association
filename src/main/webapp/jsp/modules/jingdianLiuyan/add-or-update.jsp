    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑景点评价</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">景点评价管理</li>
                        <li class="breadcrumb-item active">编辑景点评价</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">景点评价信息</h3>
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                            <!-- 级联表的字段 -->
                                    <div class="form-group col-md-6 aaaaaa jingdian">
                                        <label>景点</label>
                                        <div>
                                    ...
                                    <div class="form-group col-md-6 jingdian">
                                        <label>景点名</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            let data = {};
            getContent();
            if(window.sessionStorage.getItem('role') != '景点'){//当前登录用户不为这个
                if($("#jingdianId") !=null){
    ...
    function setContent() {
        ...
        if (ruleForm.jingdianLiuyanContent != null && ruleForm.jingdianLiuyanContent != 'null' && ruleForm.jingdianLiuyanContent != '') {
            ...
            jingdianLiuyanContentUeditor.ready(function () {
                var mes = '';
                if(ruleForm.jingdianLiuyanContent != null){
                    mes = ''+ ruleForm.jingdianLiuyanContent;
                    mes = mes.replace(/\n/g, "<br>");
                }
