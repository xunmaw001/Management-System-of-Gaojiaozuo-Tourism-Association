    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑旅游快讯</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">旅游快讯管理</li>
                        <li class="breadcrumb-item active">编辑旅游快讯</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">旅游快讯信息</h3>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                newsName: "旅游快讯名称不能为空",
                newsTypes: "旅游快讯类型不能为空",
                newsPhoto: "旅游快讯图片不能为空",
                insertTime: "旅游快讯时间不能为空",
                newsContent: "旅游快讯详情不能为空",
            }
        }).form();
    }
