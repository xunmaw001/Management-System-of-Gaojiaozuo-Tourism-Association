    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                <label class="layui-form-label">旅游快讯名称：</label>
                <div class="layui-input-block">
                    <input v-model="detail.newsName" type="text" name="newsName" id="newsName" placeholder="旅游快讯名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                <label class="layui-form-label">旅游快讯类型：</label>
                <div class="layui-input-block">
            ...
            <div class="layui-form-item" pane>
                <label class="layui-form-label">旅游快讯图片：</label>
