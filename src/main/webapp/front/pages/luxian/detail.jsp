    ...
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
					<span class="layui-breadcrumb">
						...
						<a><cite>{{detail.luxianName}}</cite></a>
					</span>

            <!-- 收藏 -->
            <a onclick="addLuxianCollection()" href="javascript:void(0)">
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                <h1 class="title">{{detail.luxianName}}</h1>

                <div v-if="detail.luxianTypes" class="detail-item">
                    <span>路线类型：</span>
                    <span class="desc">
                        {{detail.luxianValue}}
                    </span>
                ...
                <div v-if="detail.luxianJingdian" class="detail-item">
                    <span>路线经过景点：</span>
                    <span class="desc">
                                {{detail.luxianJingdian}}
                            </span>
                </div>

                <div v-if="detail.luxianNewMoney" class="detail-item">
                    <span>路线大概总花费：</span>
                    <span class="price" style="color: red">
                        {{detail.luxianNewMoney}}
                    </span>
                </div>

                <div class="detail-item">

                    <!--<button onclick="addLuxianqqqqqqqq()" type="button" class="layui-btn layui-btn-warm">
                        添加到购物车
                    </button>-->
                </div>
